  ...
  return (
    <div className="glass-card p-8 mb-8 animate-in">
      <div className="flex items-center gap-4 mb-6">
        ...
        >
          <i className="fas fa-brain text-lg" style={{ color: '#00d4ff' }}></i>
        </div>
        <span className="text-lg font-bold" style={{ color: '#ffffff' }}>AI Threat Intelligence</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="terminal-block">
          <div className="flex items-center gap-2 mb-3">
            <i className="fas fa-exclamation-triangle text-sm" style={{ color: '#ff3366' }}></i>
            <span className="section-label" style={{ color: '#ff3366' }}>DETECTED THREATS</span>
          </div>
          {threats.length > 0 ? (
            threats.map((t, i) => (
        ...
        <div className="terminal-block">
          <div className="flex items-center gap-2 mb-3">
            <i className="fas fa-lightbulb text-sm" style={{ color: '#ffcc00' }}></i>
            <span className="section-label" style={{ color: '#ffcc00' }}>AI RECOMMENDATIONS</span>
          </div>
          {recs.length > 0 ? (
            recs.map((r, i) => (
              <div key={i} className="text-sm">
      ...
      <div className="mt-6 p-5 rounded-xl" style={{ background: 'rgba(0,212,255,0.05)', border: '1px solid rgba(0,212,255,0.2)' }}>
        <div className="flex items-center gap-2 mb-3">
          <i className="fas fa-info-circle text-sm" style={{ color: '#00d4ff' }}></i>
          <span className="section-label" style={{ color: '#00d4ff' }}>AI SUMMARY</span>
        </div>
        <p className="text-sm font-semibold" style={{ color: '#d1dae6', lineHeight: 1.7 }}>
